...
uses
  ...
  Data.DB, Vcl.Mask, Vcl.ExtCtrls, Vcl.Grids, Vcl.DBGrids,ShellAPI;
...
type
  TForm2 = class(TForm)
    ...
    procedure VerPendientedePago1Click(Sender: TObject);
    procedure Verrelaciondeamigos1Click(Sender: TObject);
...
{$R *.dfm}
uses UModulo,UApellidos,UGrupo, UCobro, UMaestro;
...
datamodule1.FDAlumno.close;
datamodule1.FDAlumno.Open;
...
begin
contenedor.PageIndex:=2;
datamodule1.miconexion.connected:=true;
datamodule1.FDAlumno.open;
datamodule1.FDAmigos.open;
...
procedure TForm2.Manual1Click(Sender: TObject);
begin
...
procedure TForm2.VerPendientedePago1Click(Sender: TObject);
begin
datamodule1.informe.ShowReport();
end;

procedure TForm2.Verrelaciondeamigos1Click(Sender: TObject);
begin
form5.FDMaestro.Open();
form5.FDEsclavo.Open();
Form5.showmodal;
end;
